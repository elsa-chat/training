// Day 4, Chapter 2: MCP Fundamentals (90 min)
const day4_ch02 = {
    ...
    slides: [
        {
            ...
            content: C.titleSlide(
                ...
                "Extending SEMOSS with Tools, Resources, and Prompts",
                "90 minutes"
            )
        },
        {
            id: "d4-mcp-what-is",
            title: "What is MCP in SEMOSS?",
            content: `
                ...
                <p>In SEMOSS, MCP enables you to extend Playground and Rooms with custom capabilities by exposing app-specific functionality as <strong>tools</strong>, <strong>resources</strong>, and <strong>prompts</strong> that LLMs can discover and use.</p>
                ${C.cards([
                ...
                ${C.callout('SEMOSS implements MCP as a <strong>micro-app pattern</strong>: each MCP is a lightweight app (Project) with Python/Java/Pixel backends exposed via JSON schemas, plus optional React portal UIs.', 'info')}
            `
        },
        {
            id: "d4-mcp-architecture",
            title: "MCP Architecture in SEMOSS",
            content: `
                <h2>MCP Architecture</h2>
                <p>SEMOSS MCP integrates into the Playground and Room system, allowing models to call app-specific tools without leaving the chat interface.</p>
                ${C.layers([
...
7. Model incorporates result into response`, 'pixel', 'MCP tool execution flow')}
        ...
        {
            id: "d4-mcp-filesystem",
            title: "App Filesystem Structure",
            content: `
                <h2>MCP App Filesystem Structure</h2>
                <p>SEMOSS apps follow a canonical directory structure. MCP-related files live in specific folders:</p>
                ${C.tree([
        ...
        },
        {
            ...
            content: `
                ...
                <p>SEMOSS supports three backend patterns for MCP tools, each with different use cases:</p>
                ${C.table(
