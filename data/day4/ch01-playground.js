// Day 4, Chapter 1: Playground (90 min)
const day4_ch01 = {
    title: "Playground",
    slides: [
        {
            id: "d4-playground-title",
            title: "Playground",
...
// - Can override with options.instructions`, 'json', 'Room with workspace')
        ...
        {
            id: "d4-playground-mcp-integration",
...
public List<Map<String, Object>> getAllToolsJsonForRoom() {
    ...
    return aggregated;
        ...
        {
            id: "d4-playground-enterprise-prompt",
